...
export function getOrderDetails(orderId) {
    ...
    params.append("CheckTypeFunction", "showExclusiveLogestechsOrderDetails");
    params.append("OrderId", orderId);
...
export function getLogestechsExclusiveClientAddresses(address) {
    var params = new URLSearchParams();
    params.append("CheckTypeFunction", "getLogestechsExclusiveClientAddresses");
    params.append("creatorId", localStorage.getItem("userId"));
    params.append("searchText", address);
    params.append("TokenDevice", localStorage.getItem("TokenDevice"));
    params.append("langId", (localStorage.getItem("Language") || "en") === "en" ? "1" : "2");
...
export function createExclusiveLogestechsAddress(addressData) {

    // addressDetails, addressAditionalInfo, contactPhone, contactName, villageId, cityId, regionId

    var params = new URLSearchParams();
    params.append("CheckTypeFunction", "createExclusiveLogestechsAddress");

    params.append("contactName", addressData.contactName);
    params.append("contactPhone", addressData.contactPhone);
    params.append("addressDetails", addressData.addressDetails);
    params.append("addressAditionalInfo", addressData.addressAditionalInfo);
    params.append("villageId", addressData.villageId);
    params.append("cityId", addressData.cityId);
    params.append("regionId", addressData.regionId);
    params.append("villageEnName", addressData.villageEnName);
    params.append("villageArName", addressData.villageArName);
    params.append("regionName", addressData.regionName);
    params.append("creatorId", localStorage.getItem("userId"));
    params.append("customerId", localStorage.getItem("userId"));
    params.append("deviceToken", localStorage.getItem("TokenDevice"));
...
export function createNewLogestechsExclusiveClientOrder(deliveryParams, addresses, isNewAddress) {

    var params = new URLSearchParams();
    params.append("CheckTypeFunction", "createNewLogestechsExclusiveClientOrder");
    params.append("deliveryParams", deliveryParams);
...
export function getLogestechsExclusiveClientDefaultAddress() {
    var params = new URLSearchParams();
    params.append("CheckTypeFunction", "getLogestechsExclusiveClientDefaultAddress");
    params.append("clientId", localStorage.getItem("userId"));
    params.append("tokenDevice", localStorage.getItem("TokenDevice"));
    params.append("langId", (localStorage.getItem("Language") || "en") === "en" ? 1 : 2);
...
export function setLogestechsExclusiveClientDefaultAddress(addressId) {
    var params = new URLSearchParams();
    params.append("CheckTypeFunction", "setLogestechsExclusiveClientDefaultAddress");
    params.append("clientId", localStorage.getItem("userId"));
    params.append("tokenDevice", localStorage.getItem("TokenDevice"));
    params.append("addressId", addressId);
...
export function updateReviewedOrders(orderIds, isToReview) {
    ...
    params.append("isTransporter", isTransporter() ? "1" : "0");
...
export function getALlLogestechsAreas() {
    var params = new URLSearchParams();
    params.append("CheckTypeFunction", "getALlLogestechsAreas");
    params.append("customerId", localStorage.getItem("userId"));
