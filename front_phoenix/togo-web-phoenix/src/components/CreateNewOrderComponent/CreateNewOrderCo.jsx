...
import {
    ...
    getLogestechsExclusiveClientAddresses,
    getLogestechsExclusiveClientDefaultAddress,
    setLogestechsExclusiveClientDefaultAddress,
    getLoegstechsExclusiveClientTempAddress,
    getLogestechsAreaByName,
    createNewLogestechsExclusiveClientOrder,
...
export default function CreateNewOrder(props) {
    ...
    useEffect(() => {
        ...
        if (!isTransporter() && !!!id) {
            getLogestechsExclusiveClientDefaultAddress().then((res) => {
                if (res.data.status == "error") {
                    console.log(res.data.error)
                    dispatch(toastNotification("Error!", "Something went wrong", "error"));
                } else {
                    // console.log(res.data.pickup_address)
                    setPickUpAddress(res.data.pickup_address);
                }
            })
        }
    }, [refresh]);
    ...
    const getClientAddresses = () => {
        getLogestechsExclusiveClientAddresses(inputValue).then((res) => {
            ...
            if (res.data.status == "error") {
                ...
                setLoading(false);
                setClientAddresses(res.data.addresses);
            }
    ...
    const createOrderHandler = (DeliveryParams, AddressClint) => {

        createNewLogestechsExclusiveClientOrder(JSON.stringify(DeliveryParams), JSON.stringify(AddressClint), isNewAddress ? "1" : "0").then((res) => {
            // console.log(res.data)
    ...
    const setDefaultAddressHandler = (addressId) => {
        ...
        setLogestechsExclusiveClientDefaultAddress(addressId).then((res) => {
            if (res.data.status == "error") {
                console.log(res.data.error);
                dispatch(toastNotification("Error!", "Something went wrong", "error"));
            } else {
    ...
    const setTempAddressHandler = (address) => {
    ...
    const setDeliveryAddressHandler = (selectedAddress) => {
    ...
    /* const [allLogestechsAreas, setAllLogestechsAreas] = useState([]);

    useEffect(() => {
        setGeneralLoading(true)
        getALlLogestechsAreas().then((res) => {
            // console.log(res.data)
            setAllLogestechsAreas(res.data.areas)
                                    ...
                                    <Form id="orderForm" validated={validated} noValidate onSubmit={(event) => {
                                        ...
                                        if (form.checkValidity() === true) {
                                            ...
                                            if (isNewAddress) {
                                                ...
                                                AddressClint = {
                                                    // sender
                                                    senderVillageId: pickUpAddress.villageId,
                                                    senderRegionId: pickUpAddress.regionId,
                                                    OtherDetails: pickUpAddress.details,
                                                    SenderAddressId: pickUpAddress.id,

                                                    // receiver
                                                    receiverVillageId: villageId,
                                                    receiverVillageEnName: villageEnName,
                                                    receiverVillageArName: villageArName,
                                                    receiverCityId: cityId,
                                                    receiverRegionId: regionId,
                                                    receiverRegionName: regionName,
                                                ...
                                                AddressClint = {
                                                    ...
                                                    receiverVillageId: dileveryAddress.villageId,
                                                    receiverRegionId: dileveryAddress.regionId,

                                                    OtherDetailsDes: dileveryAddress.details,
                                                    ReceiverAddressId: dileveryAddress.id,
                                            ...
                                            if (areaValidatiy) {
                                                ...
                                                createOrderHandler(DeliveryParams, AddressClint);
                                        ...
                                        <ListGroup variant="flush" className="mt-5 customListGroup">
                                            ...
                                            <ListGroup.Item className="py-4" disabled={isReturnedOrder ? true : false}>
                                                <div className="container-fluid">
                                                    <div className="row">
                                                        <div className="mb-3 h5" style={{ color: "#1191C7" }}>
                                            ...
                                            <ListGroup.Item className="py-4" style={{ backgroundColor: "#ededed" }}>
                                                <div className="container-fluid">
                                                    <div className="d-flex align-items-center mb-3 h5" style={{ color: "#1191C7" }}>
                                            ...
                                            <ListGroup.Item className="py-4">
                                                <div className="container-fluid">
                                                    <div className="row">
                                                        <div className="d-flex align-items-center mb-2 h5" style={{ color: "#1191C7" }}>
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        {
                                                                                                            clientAddresses?.map((address, index) => {
                                                                                                                return <tr key={index}>
                                                                                                                    ...
                                                                                                                    <td style={{ width: "25%" }}>{address.details + ", " + address.areaName}</td>
                                            ...
                                            <ListGroup.Item className="py-4" style={{ backgroundColor: "#ededed" }}>
                                                <div className="container-fluid">
                                                    <div className="row">
                                                        <div className="col-lg-11 d-flex align-items-center h5 mb-3" style={{ color: "#1191C7" }}>
                                                            {
                                                                                ...
                                                                                <tbody>
                                                                                    {
                                                                                        clientAddresses?.map((address, index) => {
                                                                                            return <tr key={index}>
                                                                                                ...
                                                                                                <td style={{ width: "35%" }}>{address.details + ", " + address.areaName}</td>
                                                                                                <td style={{ width: "20%" }}>{address.phone_number}</td>
                                                                                                <td style={{ width: "15%" }}>
                                                                                                    <Button disabled={loadingSetDefault ? true : false} className="btn-grad" onClick={() => {
                                                                                                        setDeliveryAddressHandler(address);
                                                                                                    }}>
                                                                                                        {loadingSetDefault && <Spinner animation="border" size="sm" />}
                                                    ...
                                                    {(isNewAddress == true && !isReturnedOrder) ? <>
                                                        <div className="row mt-1">
                                                            <div className="col-lg-6" style={{ position: "relative" }}>
                                                                <Form.Group>
                                                                    <FloatingLabel className="" controlId="" label={translate("CREATE_NEW_ORDER.SEARCH_AREA")}>
                                                                        <Form.Control
                                                                            /* 1111 */
                                                                            /* required */
                                                                            className="rounded-22 input-inner-shadow"
                                                                ...
                                                                {(logestechsAreas.length > 0 || loadingAreas) && <div style={{
                                                                    ...
                                                                    <ul>
                                                                        {
                                                                            loadingAreas ? <li className="text-center"><Spinner size="lg" className="" animation="border" variant="dark" /></li> :
                                                                                logestechsAreas.map((area) => (
                                                                                    <li className="receiver-area-list-item d-flex justify-content-between" key={area.id} onClick={() => { selectAreaHandler(area) }}>
                                                                                        <div>{
                                                    ...
                                                    <Col lg={3} className="">
                                                        ...
                                                        <div className="row mt-1 mb-3">
                                                            ...
                                                            <div className="col-lg-6">
                                                                <label>{translate("CREATE_NEW_ORDER.AREA")}</label>
                                                                <Form.Control disabled className="input-inner-shadow" type="text" placeholder={dileveryAddress?.areaName + ", " + dileveryAddress?.provName} />
                                                            </div>
                                                        </div>
                                            ...
                                            <ListGroup.Item className="py-4" style={{ backgroundColor: "#ededed" }}>
                                                <div className="container-fluid">
                                                    ...
                                                    </Button> : <span className="h6" style={{ color: "#1191C7", float: "right" }}>{isTransporter() ? translate("TEMP.SUCCISSFULLY_PUBLISHED") : translate("TEMP.SUCCISSFULLY_PUBLISHED_CLIENT")}</span>}
                                                </div>
                                            </ListGroup.Item>
                                        </ListGroup>
                                    </Form>
